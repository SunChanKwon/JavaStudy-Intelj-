...
public class Calculator extends JFrame implements ActionListener, KeyListener{
	...
	final int MAX_INPUT_LENGTH = 20;	//�ִ��� �Է� ������ ���̸� �����ϰ�
	...
	public Calculator(){
		...
		for(int i=0 ; i<buttons.length ; i++){
			if(i<10){
				buttons[i].setForeground(Color.black);	//���� ��ư��
			}else if(i>=10 && i<21){
				buttons[i].setForeground(Color.blue);	//������ ��ư��
			}else{
				buttons[i].setForeground(Color.red);	//��Ʈ�� ��ư��.
			}
		}
		...
		//��ư ActionListener, Keylistener Ȱ��! �̳���� �߰��ؾ� ��ư�� ������ �߻��ϴ��� ���ϴ�.
		for(int i=0 ; i<buttons.length ; i++){
